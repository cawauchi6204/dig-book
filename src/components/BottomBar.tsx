...
export default function BottomBar() {
  ...
  return (
    <div className="fixed bottom-0 left-0 z-50 w-full h-16 bg-black text-white border-t border-gray-200 dark:bg-gray-700 dark:border-gray-600">
      <div className="flex h-full font-medium">
        ...
        >
          <svg
            className="w-5 h-5 mb-2 text-white group-hover:text-blue-600"
            aria-hidden="true"
